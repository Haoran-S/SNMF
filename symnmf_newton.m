function [H, iter, obj,objvalue, grad_vec, time_vec] = symnmf_newton(A,H0, k, params,maxiter, maxtime)
...
%                 objvalue(1,iter+1)=norm(A-H*H','fro');
    ...
    grad_vec = [grad_vec norm_inf(H-max(H-(H*(H'*H) - A*H), 0))];
    objvalue = [objvalue norm(A-H*H','fro')^2];
